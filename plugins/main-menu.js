...
const defaultMenu = {
  before: `Hello Kak %name 👋
  Im Luna-Botz Automated Software that performs repetitive tasks over the Internet.
─────────────
▢ Bot Versi : @v1.0.0
▢ Powered By : *Fahri Xz*
▢ Donasi  : saweria.co/FahriXz
─────────────
Ⓛ = Fitur Terbatas
Ⓟ = Fitur Berbayar
%readmore
...
'owner': 'Owner',
 ...
 let fotonya = 'https://telegra.ph/file/f4a957f5a155163212283.jpg'
 conn.sendMessage(m.chat, {
      text: text,
      contextInfo: {
      externalAdReply: {
      title: `LunaaMD - Official`,
      body: global.author,
